...
class Cemvc_App_Register extends ArrayObject
{
    /**
     * 单件注册对象类的名字.
     * @var string
     */
    private static $_registryClassName = 'Cemvc_App_Register';
     ...
     */
    public static function setClassName($registryClassName = 'Cemvc_App_Register')
    {
        if (self::$_registry !== null) {
            throw new Exception('Registry is already initialized');
        }
